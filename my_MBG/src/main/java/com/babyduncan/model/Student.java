...
public class Student implements Serializable {
     ...
     * @mbg.generated Tue Jan 02 17:09:44 CST 2018
     */
    public Student(Integer id, Gender gender, Byte grade, Short age, Long bookNum, Double score, BigDecimal total_score, String identify, String name, Date create_time, String status, byte[] avatar_bin, byte[] desc) {
        this.id = id;
        this.gender = gender;
        this.grade = grade;
        this.age = age;
