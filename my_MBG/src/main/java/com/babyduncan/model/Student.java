...
public class Student implements Serializable {
     ...
     * @mbg.generated Thu Nov 16 17:46:47 CST 2017
     */
    public Student(Gender gender, Byte grade, Short age, Integer id, Double score, BigDecimal total_score, String identify, String name, Date create_time, String status) {
        this.gender = gender;
        this.grade = grade;
        this.age = age;
        this.id = id;
